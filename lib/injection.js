...
*/
    ...
    if (theDoc.location.href === "resource://dcc-sm-at-joint-dot-ax/direct-currency-converter-2-sm/data/settings.html" ) {
        if (!theDoc.getElementById("jquery")) {
            ...
            jquery.setAttribute("src", "chrome://direct-currency-converter/content/common/jquery-2.1.1.min.js");
        ...
        if (!theDoc.getElementById("jqueryUi")) {
            ...
            jqueryUi.setAttribute("src", "chrome://direct-currency-converter/content/common/jquery-ui-1.10.4.min.js");
        ...
        if (!theDoc.getElementById("dccSettings")) {
            ...
            dccSettings.setAttribute("src", "chrome://direct-currency-converter/content/common/dcc-settings.js");
        ...
        if (!theDoc.getElementById("dccRegexes")) {
            ...
            dccRegexes.setAttribute("src", "chrome://direct-currency-converter/content/common/dcc-regexes.js");
        ...
        if (!theDoc.getElementById("dccContent")) {
            ...
            dccContent.setAttribute("src", "chrome://direct-currency-converter/content/common/dcc-content.js");
...
var windowListener = {
    ...
    register: function () {
        ...
        while (xulWindows.hasMoreElements()) {
            ...
            windowListener.loadIntoWindow(domWindow, xulWindow);
        }
    ...
    unregister: function () {
        ...
        while (xulWindows.hasMoreElements()) {
            let xulWindow = xulWindows.getNext();
            let domWindow = xulWindow.QueryInterface(Ci.nsIInterfaceRequestor).getInterface(Ci.nsIDOMWindow);
            windowListener.unloadFromWindow(domWindow, xulWindow);
        }
