...
*/
    ...
    if (theDoc.location.href === "resource://dcc-sm-at-joint-dot-ax/direct-currency-converter-2-sm/data/settings.html" ) {
        if (!theDoc.getElementById("jquery")) {
            ...
            jquery.setAttribute("src", "chrome://direct-currency-converter/content/common/jquery-2.1.3.min.js");
        ...
        if (!theDoc.getElementById("jqueryUi")) {
            ...
            jqueryUi.setAttribute("src", "chrome://direct-currency-converter/content/common/jquery-ui-1.11.2.min.js");
