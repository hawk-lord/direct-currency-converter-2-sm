...
//                request3.get();
    ...
    const ContentScriptInterface = function(aUrlProvider, anInformationHolder) {
        const sendScript = function(browserWindow) {
            // ChromeWindow
            //const browserWindow
            ...
            try {
                ...
                browserWindow.addEventListener("DccResetSettingsEvent", function(event) {
                    console.error("command " + event.target.getAttribute("command"));
                    eventAggregator.publish("resetSettings");
                }, false, true);
                browserWindow.addEventListener("DccSaveSettingsEvent", function(event) {
                    console.error("command " + event.target.getAttribute("command"));
...
/*
                    button.create(windowUtils.windows(null, { includePrivate: true })[win], {
                        ...
                        image: urlProvider("images/icon.svg"),
...
*/
                    ...
                    button.create(win, {
                        ...
                        stylesheet: urlProvider.getUrl("css/button.css")
                    });
                    // conversionButton
                    button.create(win, {
                        panel: null,
